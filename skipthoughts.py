...
#-----------------------------------------------------------------------------#
path_to_models = './model_table/'
path_to_tables = './model_table/'
#-----------------------------------------------------------------------------#
...
def load_tables():
    ...
    """
    words = []
    utable = numpy.load(path_to_tables + 'utable.npy', allow_pickle=True)
    btable = numpy.load(path_to_tables + 'btable.npy', allow_pickle=True)
